/*
	...
	See WindowsGameOS.h for a class description.
*/
						...
						Game *initGame)
{
	...
	wc.hIcon = static_cast<HICON>(LoadImage(hInstance,
                                  MAKEINTRESOURCE(IDI_SnowSamurai),
                                  IMAGE_ICON,
								  32,
                                  32,
								  LR_DEFAULTSIZE));
...
*/
void WindowsGameOS::processOSMessages()
{
	MSG msg;
...
/*
	killApp - This will destroy the Windows window.
*/
void WindowsGameOS::killApp()
{
