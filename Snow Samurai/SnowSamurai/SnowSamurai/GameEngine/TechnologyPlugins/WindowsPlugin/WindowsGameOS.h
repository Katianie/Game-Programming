...
/*
	WindowsGameOS - This method provides a Windows platform
...
class WindowsGameOS : public GameOS
{
...
public:
	...
	void setApplicationName(wchar_t *initApplicationName)
	{
		applicationName = initApplicationName;
		SetWindowText(windowHandle, applicationName);
	}

	// METHODS DEFINED IN WindowsGameOS.cpp
	WindowsGameOS(	HINSTANCE hInstance, int nCmdShow, bool isFullscreen, wchar_t *initApplicationName, Game *initGame);
	~WindowsGameOS();
