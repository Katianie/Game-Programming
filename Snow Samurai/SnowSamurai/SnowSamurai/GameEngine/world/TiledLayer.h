...
public:
	...
	TiledLayer(){}
	TiledLayer(int initColumns, int initRows, int initTileWidth, int initTileHeight, int initZ, bool initCollidableTiles, Viewport *viewport, int worldWidth, int worldHeight);
	~TiledLayer();
	...
	void	init(int initColumns, int initRows, int initTileWidth, int initTileHeight, int initZ, bool collidableTiles, Viewport *viewport, int worldWidth, int worldHeight);
