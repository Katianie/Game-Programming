...
#include "../GameEngine/game/IllegalArgumentException.h"
...
ScreenGUI* GameGUI::getScreenGUI(int index)
{
	return screens->at(index);
}


void GameGUI::setScreenGUI(int index, ScreenGUI *screenToAdd)
{
	screens->at(index) = screenToAdd;
}
/*
