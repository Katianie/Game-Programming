...
public:
	...
	wchar_t*	getCommand()			{ return command;				}
	...
	{ height = initHeight;							}
	void setCommand(wchar_t *changeCommand)
	...
	void initButton(int initNormalTextureID, int initMouseOverTextureID, int initX, int initY, int initZ, int initAlpha, int initWidth, int initHeight, bool initMouseOver, wchar_t *initCommand);
